...
function OperationsRoute(){const[params]=useSearchParams();const tab=params.get('tab');if(tab==='declaration')return <DeclarationChecklistPage/>;if(tab==='exit')return <ExitPage/>;return <PreDeclarationPage/>}
