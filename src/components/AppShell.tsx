...
import {Activity,Anchor,BarChart3,Building2,Calculator,ChevronLeft,ChevronRight,FileCheck2,FileText,FileSearch,History,LayoutDashboard,Menu,Palette,Printer,Settings2,ShieldCheck,Ship,Truck,X,LogOut,Sun,Moon,Wallet} from 'lucide-react';
...
const nav=[
 ...
 {label:'استخراج هوشمند اسناد',en:'Document Intelligence',to:'/documents/extract',icon:FileSearch,group:'ترخیص'},
...
export const AppShell:React.FC<{children:React.ReactNode}>=({children})=>{
 ...
 return <div className="app-shell min-h-screen" dir="rtl">
  ...
  </main><OfflineQueueStatus/><AIWorkspace pageContext={location.pathname+location.search}/>
 </div>;
};